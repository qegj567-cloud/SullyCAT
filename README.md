...
本项目之前挂的是 MIT，从这次提交开始换成 PolyForm NC。法律上讲：

- 之前已经 fork 走 MIT 版本的人，那个旧副本对他们仍然是 MIT——没办法，泼出去的水。
- 从现在起的新版本、新提交、新功能，全部走 PolyForm NC。
- 想继续白嫖请回去翻旧 commit，想用最新的我就请遵守新协议。合理吧？
